...
class ReservoirCell(torch.nn.Module):
    def __init__(self,
        ...
        :param input_scaling: Max abs value of a weight in the input-reservoir
            connections. Note that this value also scales the unitary input bias.
        :param spectral_radius: Max abs eigenvalue of the recurrent matrix.
        :param leaky_rate: Leaking rate constant of the reservoir.
        :param input_connectivity: Number of outgoing connections from each
            input unit to the reservoir.
        :param recurrent_connectivity: Number of incoming recurrent connections
            for each reservoir unit.
        :param bias: Boolean variable decides whether to apply a bias or not
            inside the non-linearity.
        :param non_linearity: String value can be either 'tanh' or 'identity'.
        ...
        :param bias_scaling: If None, then rescale the bias vector with the
        ...
        self.state_size = recurrent_units
